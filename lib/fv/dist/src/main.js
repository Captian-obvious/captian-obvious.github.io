    ...
    Load: function(type){
        ...
        if (type==='audio') {
            ...
            <div class='red1 middle' id='MediaPlayerControls' style='top: 70'>
                <div id='playpause' class='MediaPlayerIcon icon-play' style='width: 16px; height: 16px;'></div>
                <input class='middle' type='range' id='MediaPlayerSeek' class='MediaPlayerControl seekbar' style='width: 95%; height: 5px; left: 4%; top: 8px;'></input>
            </div>
            `
        }
    },
