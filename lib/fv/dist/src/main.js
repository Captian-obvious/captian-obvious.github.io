    ...
    Load: function(type){
        ...
        if (type==='audio') {
            ...
            <div class='red1 middle' id='MediaPlayerControls' style='top: 70%'>
                <div id='playpause' class='MediaPlayerIcon icon-play' style='width: 10%; height: 10%; aspect-ratio: 1/1; top: 70%;'></div>
                <input class='middle' type='range' id='MediaPlayerSeek' class='MediaPlayerControl seekbar' style='width: 95%; height: 5px; left: 4%; top: 72%;'></input>
            </div>
            `
        }
    },
